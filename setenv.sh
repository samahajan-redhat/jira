...
#
JVM_SUPPORT_RECOMMENDED_ARGS="-Datlassian.recovery.password=redhat -XX:+UseG1GC -Dfile.encoding=utf-8 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/opt/atlassian/jira/"
