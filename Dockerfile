...
RUN microdnf install -y python36 python36-devel python36-libs python36-pip python36-setuptools rsync findutils procps vim lsof iputils openssl curl fontconfig tar unzip \
